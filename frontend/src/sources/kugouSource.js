...
// 真实接通需逆向酷狗 signature 签名（MD5）并做合规评估，不在本次默认范围。

const notSupported = (what) => {
  throw new Error(`[kugou] 暂未支持：${what}（适配器骨架，待实现）`);
};

export const kugouSource = {
  id: 'kugou',
  name: '酷狗音乐',
  loginDomains: ['https://www.kugou.com'],
  ready: false,
